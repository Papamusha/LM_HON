...
import { Choropleth } from './Choropleth All/index.js';
...
function ChoroplethRender() {
  ...
  return (
    ...
    <svg width={width} height={height}> 
      <Choropleth data={data} filteredData={filteredData} map={map} />
...
export default ChoroplethRender;